        ...
        <div class="content container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="widget-container">
                        <div class="panel-body"><a class="thumb pull-left m-r" href="#"> <img class="img-circle"
                                                                                              src="images/user.jpg"></a>
                            <div class="clear"><a class="text-info" href="#">@John Doe <i class="icon-twitter"></i></a>
                                <small class="block text-muted">7,257 followers / 342 tweets</small> <a
                                    class="btn btn-xs btn-info m-t-xs" href="#">Follow</a></div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="panel terques-chart">
                        <div class="panel-body chart-texture">
                            <div class="chart">
                                ...
                                <div class="sparkline" data-type="line" data-resize="true" data-height="90"
                        ...
                        <div class="chart-tittle"><span class="title">New Earning</span> <span class="value-pie"> <a
                                    href="#" class="active">Market</a> | <a href="#">Referal</a> | <a
                                    href="#">Online</a> </span></div>
                    </div>
                    <!--new earning end-->
                </div>
                <div class="col-lg-4">
                    ...
                    <div class="panel green-chart">
                        ...
                        <div class="chart-tittle"><span class="title">Total Earning</span> <span class="value-pie">$, 85,34,577</span>
                        </div>
                    </div>
                    <!--total earning end-->
                </div>
                        ...
                        <div class="widget-content">
                            <ul class="to-do-list ui-sortable" id="sortable-todo">
                                <li class="clearfix"><span class="drag-marker"> <i></i> </span>
                                    ...
                                    <div class="todo-actionlist pull-right clearfix"><a href="#" class="todo-done"><i
                                                class="icon-ok"></i></a> <a href="#" class="todo-edit"><i
                                                class="icon-pencil"></i></a> <a class="todo-remove"><i
                                                class="icon-remove icon-muted"></i></a></div>
                                </li>
                                <li class="clearfix"><span class="drag-marker"> <i></i> </span>
                                    <div class="todo-check pull-left">
                            ...
                            <div class="todo-action-bar">
                                ...
                                <div class="row">
                                    <div class="col-xs-3 btn-todo-select">
                                        <button type="submit" class="btn btn-default"><i class="icon-ok"></i> Select All
                                        </button>
                                    </div>
                                    <div class="col-xs-6 todo-search-wrap">
                                        <input type="text" class="form-control todo-search pull-right"
                                               placeholder=" Search">
                                    </div>
                                    <div class="col-xs-3 btn-add-task">
                                        <button type="submit" class="btn btn-default btn-danger"><i
                                                class="icon-plus"></i> Add Task
                                        </button>
                                    </div>
                                </div>
                                <!--row end-->
                        ...
                        <div class="widget-content">
                            <div class="table-responsive" style="overflow-x:auto">
                                <table class="table">
                                    ...
                                    <tfoot>
                                    <tr class="active">
                                        <td colspan="4" class="text-left table-bg"><label for="action"
                                                                                          style="margin-bottom:0">Action </label>
                                            <select name="action">
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-content">
                            <div class="timeline-messages">
                                <!-- Comment -->
                                <div class="msg-time-chat"><a href="#" class="message-img"><img class="avatar"
                                                                                                src="images/avatar.jpg"
                                                                                                alt=""></a>
                                    <div class="message-body msg-in"><span class="arrow"></span>
                                        <div class="text">
                                            <p class="attribution"><a href="#">John Doe</a> at 1:55pm, 13th April 2013
                                            </p>
                                ...
                                <div class="msg-time-chat"><a href="#" class="message-img"><img class="avatar"
                                    ...
                                    <div class="message-body msg-out"><span class="arrow"></span>
                                        <div class="text">
                                            <p class="attribution"><a href="#">Dale Steyn</a> at 2:01pm, 13th April 2013
                                            </p>
                                ...
                                <div class="msg-time-chat"><a href="#" class="message-img"><img class="avatar"
                                    ...
                                    <div class="message-body msg-in"><span class="arrow"></span>
                                        <div class="text">
                                            <p class="attribution"><a href="#">John Doe</a> at 2:03pm, 13th April 2013
                                            </p>
                                ...
                                <div class="msg-time-chat"><a href="#" class="message-img"><img class="avatar"
                                    ...
                                    <div class="message-body msg-out"><span class="arrow"></span>
                                        <div class="text">
                                            <p class="attribution"><a href="#">Dale Steyn</a> at 2:05pm, 13th April 2013
                                            </p>
                                            ...
                                            <li><img class="pull-left img-circle" alt="" src="images/img1.jpg">
                                                <div class="user-info">
                                                    ...
                                                    <div class="comment"> Lorem ipsum dolor sit amet, consectetur
                                                        adipiscing elit. Integer faucibus consectetur malesuada.
                                                    </div>
                                                </div>
                                            </li>
                                            <li><img class="pull-left img-circle" alt="" src="images/img1.jpg">
